...
public class TrapManager : Singleton<TrapManager>
{
    ...
    protected override void InitManager()
    {
        ...
        trap_Data.Add(new TrapData(0, "DartTrap", 2, 0.65f, 500, 9999, 3, 1));
        trap_Data.Add(new TrapData(1, "BoltTrap", 6, 3.5f, 700, 9999, 3, 1));
        trap_Data.Add(new TrapData(2, "SpikeTrap", 3, 2.0f, 650, 9999, 0, 0));
        trap_Data.Add(new TrapData(3, "Barricade", 0, 0.0f, 550, 3, 0, 0));
        trap_Data.Add(new TrapData(4, "SlimeTrap", 0, 0.0f, 300, 9999, 0, 0));
        trap_Data.Add(new TrapData(5, "PushTrap", 2, 5.0f, 500, 9999, 1, 1));
        trap_Data.Add(new TrapData(6, "SpearTrap", 3, 4.0f, 200, 9999, 4, 1));
    }

    public int GetTrapType(int id)
    {
